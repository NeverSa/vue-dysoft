...
!function (n, i) {
    ...
    (function (n) {
        ...
        function r() {
            _ = s(),
            v.supportsTransitionEnd() && (n.event.special[v.TRANSITION_END] = i())
        }
        var l = "metisMenu"
          , f = "metisMenu"
          , c = "." + f
        ...
        var C = function () {
            ...
            return o(i, [{
                ...
                value: function () {
                    var i = this;
                    n(this._element).find("li." + this._config.activeClass).has("ul").children("ul").attr("aria-expanded", !0).addClass(this._config.collapseClass + " " + this._config.collapseInClass),
                    n(this._element).find("li").not("." + this._config.activeClass).has("ul").children("ul").attr("aria-expanded", !1).addClass(this._config.collapseClass),
                    this._config.doubleTapToGo && n(this._element).find("li." + this._config.activeClass).has("ul").children("a").addClass("doubleTapToGo"),
                    n(this._element).on(p.CLICK_DATA_API, "li a", function (e) {
                        ...
                        var t = n(this)
                          , o = t.parent("li")
                          , s = o.children("ul");
                        return i._config.preventDefault && e.preventDefault(),
                        "true" !== t.attr("aria-disabled") ? (o.hasClass(i._config.activeClass) && !i._config.doubleTapToGo ? (t.attr("aria-expanded", !1),
                        i._hide(s)) : (i._show(s),
                        t.attr("aria-expanded", !0)),
                        i._config.onTransitionStart && i._config.onTransitionStart(e),
                        i._config.doubleTapToGo && i._doubleTapToGo(t) && "#" !== t.attr("href") && "" !== t.attr("href") ? (e.stopPropagation(),
                        void (document.location = t.attr("href"))) : void 0) : void 0
                    })
                }
            }, {
                key: "_show",
                    ...
                    if (!this._transitioning && !n(i).hasClass(this._config.collapsingClass)) {
                        ...
                        if (t.length) {
                            ...
                            !o.isDefaultPrevented()) {
                                t.parent("li").addClass(this._config.activeClass),
                                this._config.toggle && this._hide(t.parent("li").siblings().children("ul." + this._config.collapseInClass).attr("aria-expanded", !1)),
                                t.removeClass(this._config.collapseClass).addClass(this._config.collapsingClass).height(0),
                                this.setTransitioning(!0);
                                var s = function () {
                                    t.removeClass(e._config.collapsingClass).addClass(e._config.collapseClass + " " + e._config.collapseInClass).height("").attr("aria-expanded", !0),
                                    e.setTransitioning(!1),
                                    t.trigger(p.SHOWN)
                                };
                                if (!v.supportsTransitionEnd())
                                    return void s();
                                t.height(t[0].scrollHeight).one(v.TRANSITION_END, s),
                                a(h)
                            }
                        }
                    }
                ...
                value: function (i) {
                    if (!this._transitioning && n(i).hasClass(this._config.collapseInClass)) {
                        ...
                        if (t.length) {
                            ...
                            if (t.trigger(o),
                            !o.isDefaultPrevented()) {
                                t.parent("li").removeClass(this._config.activeClass),
                                t.height(t.height())[0].offsetHeight,
                                t.addClass(this._config.collapsingClass).removeClass(this._config.collapseClass).removeClass(this._config.collapseInClass),
                                this.setTransitioning(!0);
                                var s = function () {
                                    e._transitioning && e._config.onTransitionEnd && e._config.onTransitionEnd(),
                                    e.setTransitioning(!1),
                                    t.trigger(p.HIDDEN),
                                    t.removeClass(e._config.collapsingClass).addClass(e._config.collapseClass).attr("aria-expanded", !1)
                                };
                                if (!v.supportsTransitionEnd())
                                    return void s();
                                0 == t.height() || "none" == t.css("display") ? s() : t.height(0).one(v.TRANSITION_END, s),
                                a(h)
                            }
                        }
                    }
                ...
                key: "_doubleTapToGo",
                value: function (i) {
                    return i.hasClass("doubleTapToGo") ? (i.removeClass("doubleTapToGo"),
                    !0) : i.parent().children("ul").length ? (n(this._element).find(".doubleTapToGo").removeClass("doubleTapToGo"),
                    i.addClass("doubleTapToGo"),
                    !1) : void 0
                }
            }, {
        ...
        return n.fn[l] = C._jQueryInterface,
        n.fn[l].Constructor = C,
    ...
    $.niftyNoty = function (options) {
        var defaults = {
            ...
            floating: {
                ...
                animationOut: 'fadeOut'// Please use the animated class name from animate.css
            ...
            onHidden: function () { }// This event is fired when the notification has finished being hidden from the user (will wait for CSS transitions to complete).

        }, opt = $.extend({}, defaults, options), el = $('<div class="alert-wrap"></div>'), iconTemplate = function () {
            var icon = '';
            if (options && options.icon) {
                icon = '<div class="media-left alert-icon"><i class="' + opt.icon + '"></i></div>';
            }
            return icon;
        }, alertTimer, template = function () {
            ...
            if (opt.container === 'page') {
                if (!pageHolder) {
                    ...
                    if (!niftyContentContainer || !niftyContentContainer.length)
                        niftyContentContainer = $('#content-container');
                ...
                if (!floatContainer[opt.floating.position]) {
                    ...
                    if (!niftyContainer || niftyContentContainer || (niftyContentContainer && !niftyContentContainer.length)) {
                        niftyContainer = $('#container');
                    }
                    if (niftyContainer.length <= 0 || (niftyContentContainer && !niftyContentContainer.length)) {
                        niftyContainer = $('body');
                    }
...
!function ($) {
    ...
    var allFormEl, formElement = function (el) {
    ...
    bindSmallNav = function () {
        ...
        $menulink.each(function () {
            ...
            $el.popover({
                ...
                if (offsetTop > offsetBottom) {
                    ...
                    if (!niftyContainer.hasClass('navbar-fixed') && niftyMainNav.hasClass('affix-top'))
                        offsetBottom -= 50;
      ...
      , updateSize = function () {
          ...
          if (screenCat != currentScreen) {
              ...
              } else if (screenSize == "lg") {//$.niftyNav('expand');
              }
          }
      }
      ...
      , methods = {
          'revealToggle': function () {
              if (!niftyContainer.hasClass('reveal'))
                  niftyContainer.addClass('reveal');
          ...
          'slideToggle': function () {
              if (!niftyContainer.hasClass('slide'))
                  niftyContainer.addClass('slide');
              niftyContainer.toggleClass('mainnav-in mainnav-out').removeClass('mainnav-lg mainnav-sm')
              if (isSmallNav)
                  unbindSmallNav();
              return;
          ...
          'pushToggle': function () {
              niftyContainer.toggleClass('mainnav-in mainnav-out').removeClass('mainnav-lg mainnav-sm');
              if (niftyContainer.hasClass('mainnav-in mainnav-out'))
...
!function ($) {
    ...
    var niftyAside = null, niftyContainer, niftyWindow = $(window), asideMethods = {
    ...
    }, boxedContainer = $('#container').children('.boxed'), navlg = 0, navsm = 0, updateAside = function () {
        try {
        ...
        if (niftyAside.length) {
            ...
            // http://jamesflorentino.github.io/nanoScrollerJS/
            // =================================================================
            niftyAside.find('.nano').nanoScroller({
                preventPageScrolling: (niftyContainer.hasClass('aside-fixed') ? true : false)
            });
...
!function ($) {
    ...
    var niftyMainNav, niftyAside, niftyContainer, niftyMainnavScroll, niftyAsideScroll, updateScrollInterval, updateScroll = function (e) {
        clearInterval(updateScrollInterval);
        updateScrollInterval = setInterval(function () {
        ...
        if (niftyMainNav.length)
            niftyMainNav.niftyAffix({
                className: 'mainnav-fixed'
            });
        if (niftyAside.length)
            niftyAside.niftyAffix({
